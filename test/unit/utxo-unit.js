...
describe('#utxo', () => {
  ...
  describe('#get', () => {
    ...
    it('should have expected properties in slpUtxos.type1.mintBatons', async () => {
      ...
      // Assert expected properties exist in result.slpUtxos.type1.mintBatons
      assert.property(result.slpUtxos.type1.mintBatons[0], 'height')
      assert.property(result.slpUtxos.type1.mintBatons[0], 'tx_hash')
      assert.property(result.slpUtxos.type1.mintBatons[0], 'tx_pos')
      assert.property(result.slpUtxos.type1.mintBatons[0], 'value')
      assert.property(result.slpUtxos.type1.mintBatons[0], 'txid')
      assert.property(result.slpUtxos.type1.mintBatons[0], 'vout')
      assert.property(result.slpUtxos.type1.mintBatons[0], 'isSlp')
